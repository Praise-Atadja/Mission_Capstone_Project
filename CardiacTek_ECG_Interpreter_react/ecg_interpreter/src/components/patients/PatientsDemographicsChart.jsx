...
const PatientsDemographicsData = [
	{ name: "18-24", value: 20 },
	{ name: "25-34", value: 30 },
	{ name: "35-44", value: 25 },
	{ name: "45-54", value: 15 },
...
const PatientsDemographicsChart = () => {
	return (
		<motion.div
			...
			<div style={{ width: "100%", height: 300 }}>
				<ResponsiveContainer>
					<PieChart>
						...
						>
							{PatientsDemographicsData.map((entry, index) => (
...
export default PatientsDemographicsChart;
